...
DESeq2_BC1_DU.BF <- read.csv("/home/fllobet/Documents/RNA-Seq_TFM/BC1_DU.BF/ISOFORMS/BC1_DU.iF.BF.SF.Results_a_0.05.csv", sep = ";")

# |FC| > 1.5 filtering
DESeq2_BC1_DU.BF <- DESeq2_BC1_DU.BF[which(DESeq2_BC1_DU.BF[,4] >= log2(1.5) | DESeq2_BC1_DU.BF[,4] <= -log2(1.5)),]

# FDR < 0.05 filtering 
DESeq2_BC1_DU.BF <- DESeq2_BC1_DU.BF[which(DESeq2_BC1_DU.BF[,8] < 0.05),]

# Loading of the results from EBSeq
EBSeq_BC1_DU.BF <- read.csv("/home/fllobet/Documents/RNA-Seq_TFM/BC1_DU.BF/ISOFORMS/EBSeq/BC1_DU.iF.BF_EBrb.Results.csv", sep = ";")

# |FC| > 1.5 filtering
EBSeq_BC1_DU.BF <-  EBSeq_BC1_DU.BF[which(EBSeq_BC1_DU.BF[,4] >= log2(1.5) | EBSeq_BC1_DU.BF[,4] <= -log2(1.5)),]

# PP DE > 0.95 filtering 
EBSeq_BC1_DU.BF <- EBSeq_BC1_DU.BF[which(EBSeq_BC1_DU.BF[,6] > 0.95),]
```
...
# <- cbind(DESeq2_BC1_DU.BF[,1], DESeq2_BC1_DU.BF)
# DESeq2_BC1_DU.BF[,1:2] <- str_split_fixed(DESeq2_BC1_DU.BF[,1],"_", n = 2) 

# Creating a list cotaining the lists of ID's
sets_of_DEI <- list(DESeq2 = DESeq2_BC1_DU.BF$ENSEMLB.ID, EBSeq = EBSeq_BC1_DU.BF$ENSEMBL.ID)
...
saveRDS(vn, "~/Documents/RNA-Seq_TFM/Extra_figures/venn/BC1_DU.BF.rds")
