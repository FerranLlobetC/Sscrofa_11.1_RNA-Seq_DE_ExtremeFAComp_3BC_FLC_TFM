...
cnt.BC1_DU.LV <- read.delim("/home/fllobet/Documents/RNA-Seq_TFM/BC1_DU.LV/IntegerCOUNTS.BC1_DU.liver.csv", sep = ";")

# Feature ID as row name
rownames(cnt.BC1_DU.LV) <- cnt.BC1_DU.LV[,1]

cnt.BC1_DU.LV <- cnt.BC1_DU.LV[,2:length(cnt.BC1_DU.LV)]
...
CMX_dds.BC1_DU.LV <- counts(dds.BC1_DU.LV)
colnames(CMX_dds.BC1_DU.LV) <- str_replace(colnames(CMX_dds.BC1_DU.LV),"X","")
CMX_dds.BC1_DU.LV <- cbind(rownames(CMX_dds.BC1_DU.LV), CMX_dds.BC1_DU.LV) 
colnames(CMX_dds.BC1_DU.LV) <- c("Feature", colnames(CMX_dds.BC1_DU.LV)[2:dim(CMX_dds.BC1_DU.LV)[2]])
#write.table(CMX_dds.BC1_DU.LV, file = "/home/fllobet/Documents/RNA-Seq_TFM/BC1_DU.LV/IntegerCOUNTS.BC1_DU.liver.csv", sep =";", row.names = FALSE)
################################################################################
# Removal of unutilized objects
rm(tx.BC1_DU.LV)
```
...
```{r removal_70225}
# Visualization of the animal list to identify the index which is the animal 
# to remove
colData(dds.BC1_DU.LV)[8,]

# Removal of 70225
dds.BC1_DU.LV <- dds.BC1_DU.LV[,-8]

# Visualization of the animal list to confirm the changes
colData(dds.BC1_DU.LV)
```
...
write.table(DFres.BC1_DU.LV.a_0.05, row.names = FALSE, 
          file="BC1_DU.LV.SF_wo70436_Results_a_0.05.csv", sep = ";")
```
...
Features <- rownames(res.BC1_DU.LV_abv.blw_fc.15[which(res.BC1_DU.LV_05abv.blw_fc.15$padj < 0.05),])
Features
...
# Wiritn of the csv
write.table(df, "BC1_DU.LV_JUST.sj_counts_Signif0.05_FC_1.5.csv", row.names = FALSE, sep = ";")
```
