...
# 'stringsAsFactors' is true because 'DESeq2' uses them as factors. 
Animals <- read.delim("/home/fllobet/Documents/RNA-Seq_TFM/Animals.csv", sep = ";", stringsAsFactors = TRUE)
...
BC1_DU.PORK_07 <- file.path("/home/fllobet/Documents/RNA-Seq_TFM/COUNTS/Genes/PK07", paste0(Animals.BC1_DU.LV$SAMPLE_NAME, ".genes.results"))
# Names of the columns
names(BC1_DU.PORK_07) <- paste0("X", Animals.BC1_DU.LV$SAMPLE_NAME) 
# The 'X' is necessary because R cannot use column names staring wiht a number.

### IMPORT
tx.BC1_DU.LV <- tximport(BC1_DU.PORK_07, type ="rsem", txIn = FALSE, txOut = FALSE)

# Header of the imported counts
head(tx.BC1_DU.LV$counts)
...
tx.BC1_DU.LV$length[tx.BC1_DU.LV$length == 0] <- 1
...
```{r dds_object}
### Standard 'dds' object:
dds.BC1_DU.LV <- DESeqDataSetFromTximport(tx.BC1_DU.LV,
                              colData = Animals.BC1_DU.LV,
                              design = ~ Group) # This design is temporary. 

# Header of the counts now converted into positive integers: 
...
write.table(CMX_dds.BC1_DU.LV, file = "/home/fllobet/Documents/RNA-Seq_TFM/BC1_DU.LV/IntegerCOUNTS.BC1_PI.liver.csv", sep =";", row.names = FALSE)
################################################################################
# Removal of unutilized objects
rm(tx.BC1_DU.LV)
```
...
resV2 <- res.BC1_PI.LV.a_0.05[which(res.BC1_PI.LV.a_0.05$padj < 0.1),]
