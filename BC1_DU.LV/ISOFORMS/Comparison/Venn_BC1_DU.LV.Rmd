...
DESeq2_BC1_DU.LV <- read.csv("/home/fllobet/Documents/RNA-Seq_TFM/BC1_DU.LV/ISOFORMS/BC1_DU.iF.LV.SF.Results_a_0.05.csv", sep = ";")

# |FC| > 1.5 filtering
DESeq2_BC1_DU.LV <- DESeq2_BC1_DU.LV[which(DESeq2_BC1_DU.LV[,4] >= log2(1.5) | DESeq2_BC1_DU.LV[,4] <= -log2(1.5)),]

# FDR < 0.05 filtering 
DESeq2_BC1_DU.LV <- DESeq2_BC1_DU.LV[which(DESeq2_BC1_DU.LV[,8] < 0.05),]

# Loading of the results from EBSeq
EBSeq_BC1_DU.LV <- read.csv("/home/fllobet/Documents/RNA-Seq_TFM/BC1_DU.LV/ISOFORMS/EBSeq/BC1_DU.iF.LV_EBrb.Results.csv", sep = ";")

# |FC| > 1.5 filtering
EBSeq_BC1_DU.LV <-  EBSeq_BC1_DU.LV[which(EBSeq_BC1_DU.LV[,4] >= log2(1.5) | EBSeq_BC1_DU.LV[,4] <= -log2(1.5)),]

# PP DE > 0.95 filtering 
EBSeq_BC1_DU.LV <- EBSeq_BC1_DU.LV[which(EBSeq_BC1_DU.LV[,6] > 0.95),]
```
...
# <- cbind(DESeq2_BC1_DU.LV[,1], DESeq2_BC1_DU.LV)
# DESeq2_BC1_DU.LV[,1:2] <- str_split_fixed(DESeq2_BC1_DU.LV[,1],"_", n = 2) 

# Creating a list cotaining the lists of ID's
sets_of_DEI <- list(DESeq2 = DESeq2_BC1_DU.LV$ENSEMLB.ID, EBSeq = EBSeq_BC1_DU.LV$ENSEMBL.ID)
...
saveRDS(vn, "~/Documents/RNA-Seq_TFM/Extra_figures/venn/BC1_DU.LV.rds")
