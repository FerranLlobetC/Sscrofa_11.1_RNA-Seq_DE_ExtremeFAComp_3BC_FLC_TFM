...
## Removal of superoutlier

In the PCA above we saw that at least 3 animals were **SuperOutliers** so we choose to remove them
```{r}

colData(dds.BC1_LD.BF)
# Animal: 4791 - 4; 70104 - 6:
dds.BC1_LD.BF <- dds.BC1_LD.BF[,-4]
colData(dds.BC1_LD.BF)
# Animal 70127 - 8:
dds.BC1_LD.BF <- dds.BC1_LD.BF[,-8]
colData(dds.BC1_LD.BF)
# Animal 70152 - 8:
dds.BC1_LD.BF <- dds.BC1_LD.BF[,-9]
colData(dds.BC1_LD.BF)
```
...
write.table(as.data.frame(na.omit(res.BC1_LD.BF)), 
          file="BC1_PI.BF.SF_NOSupOUT_DEGanalysis_results_a_0.1.csv", sep = ";")
...
write.table(DFres.BC1_LD.BF.a_0.05, row.names = FALSE, 
          file="BC1_PI.BF.SF_NOSupOUT_DEGanalysis_results_a_0.05.csv", sep = ";")
```
...
# Wiritn of the csv
write.table(df, "BC1_LD.BF_SF.NOSupOUT_counts_Signif0.05_FC_1.5.csv", row.names = FALSE, sep = ";")
```
