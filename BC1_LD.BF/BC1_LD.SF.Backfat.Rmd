...
write.table(as.data.frame(na.omit(res.BC1_LD.BF)), 
          file="BC1_PI.BF.SF.DEGanalysis_results_a_0.1.csv", sep = ";")
...
write.table(DFres.BC1_LD.BF.a_0.05, row.names = FALSE, 
          file="BC1_LD.BF.SF.DEGanalysis_results_a_0.05.csv", sep = ";")
```
...
# Wiritn of the csv
write.table(df, "BC1_LD.BF_SF_counts_Signif0.05_FC_1.5.csv", row.names = FALSE, sep = ";")
```
