...
The uncertainty-containing decimal counts were converted into integer counts usinng `tximport` in the script `BC1_LD.LD.IsF_loading.Rmd`

```{r couts_LOADING}
cnt.BC1_LD.iF.LD <- read.delim("/home/fllobet/Documents/RNA-Seq_TFM/BC1_LD.LD/IsoFORM_COUNTS.BC1_LD.ld.csv", sep = ";")

# Feature ID as row name
rownames(cnt.BC1_LD.iF.LD) <- cnt.BC1_LD.iF.LD[,1]

cnt.BC1_LD.iF.LD <- cnt.BC1_LD.iF.LD[,2:length(cnt.BC1_LD.iF.LD)]

cnt.BC1_LD.iF.LD <- cnt.BC1_LD.iF.LD[,order(colnames(cnt.BC1_LD.iF.LD))]
...
```{r dds_object}
### Standard 'dds' object:
dds.BC1_LD.iF.LD <- DESeqDataSetFromMatrix(cnt.BC1_LD.iF.LD,
...
capt <- expression(paste("Counts of ", bold("muscle"), " samples of ", bold("BC1_LD")))
...
saveRDS(pcaData, "~/Documents/RNA-Seq_TFM/Extra_figures/dq2_ISF_PCA/BC1_LD.LD.rds")
