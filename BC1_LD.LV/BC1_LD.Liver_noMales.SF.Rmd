...
saveRDS(pcaData, file = "~/Documents/RNA-Seq_TFM/Extra_figures/dq2_PCA/BC1_LD.LV.rds")
...
write.table(as.data.frame(res.noMales.a_0.05), 
          file="BC1_LD.LV.SF.Results_noMales_a_0.05.csv", sep = ";")
```
...
write.table((rownames(res.BC1_LD.LV.a_0.05[which(res.BC1_LD.LV.a_0.05$padj < 0.05),])),"./toBIOstars.sij_005.csv", sep = ";")
...
# Selection of the features with a log2 FC higher or lower than 1.2:
# Higher
res.BC1_LD.LV_05above_fc.12 <- res.noMales.a_0.05[which(res.noMales.a_0.05$log2FoldChange >= lg2_fc1.2),]
# Lower 
res.BC1_LD.LV_05below_fc.12 <- res.noMales.a_0.05[which(res.noMales.a_0.05$log2FoldChange <= -lg2_fc1.2),]
# Merge
...
write.table((rownames(res.BC1_LD.LV_05abv.blw_fc.15[which(res.BC1_LD.LV_05abv.blw_fc.15$padj < 0.05),])),"./toBIOstars.sij_1.5_005.csv", sep = ";")
```
