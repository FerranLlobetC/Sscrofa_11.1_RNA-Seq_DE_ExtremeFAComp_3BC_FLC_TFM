...
write.table(as.data.frame(na.omit(res.BC1_PI.BF)), 
          file="BC1_PI.BF.SF_NO.Outlier_Results_a_0.1.csv", sep = ";")
...
write.table(DFres.BC1_PI.BF.a_0.05, row.names = FALSE, 
          file="BC1_PI.BF.SF_NO.Outlier_Results_a_0.05.csv", sep = ";")
```
...
df <- df[,c("Features",rownames(colData(dds.BC1_PI.BF)[order(colData(dds.BC1_PI.BF)[,8]),]))]
# Replace of the 'X'
...
# Wiritn of the csv
write.table(df, "BC1_PI.BF.SF_NO.Outlier_counts_Signif0.05_FC_1.5.csv", row.names = FALSE, sep = ";")
```
```{r counts_0.05_signif}
# Generation of .csv containing just those features 
...
# Wiritn of the csv
write.table(df, "BC1_PI.BF.SF_NO.Outlier_counts_Signif0.05_FC_1.2.csv", row.names = FALSE, sep = ";")
```