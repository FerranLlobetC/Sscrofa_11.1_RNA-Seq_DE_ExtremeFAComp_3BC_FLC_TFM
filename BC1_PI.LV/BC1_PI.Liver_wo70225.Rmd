...
# Removal of 70225
dds.BC1_PI.LV_wo70225 <- dds.BC1_PI.LV[,-3]

# Visualization of the animal list to confirm the changes
colData(dds.BC1_PI.LV_wo70225)
```
...
dds.BC1_PI.LV_wo70225$Group <- relevel(dds.BC1_PI.LV_wo70225$Group, 
                                           ref = "L")
```
...
dds.BC1_PI.LV_wo70225 <- DESeq(dds.BC1_PI.LV_wo70225)
# Results with a == 0.1
res.BC1_PI.LV_wo70225 <- results(dds.BC1_PI.LV_wo70225)
# Results with a == 0.05
res.BC1_PI.LV_wo70225.a_0.05 <- results(dds.BC1_PI.LV_wo70225, alpha=0.05)
```
...
summary(res.BC1_PI.LV_wo70225)

# Number of significant LFCs...
sum(res.BC1_PI.LV_wo70225$padj < 0.1, na.rm = TRUE)

```

```{r DEGA_results_embellishment_a_0.05}
# Summary of the up and down regulated genes in this study:
summary(res.BC1_PI.LV_wo70225.a_0.05)

# Number of significant LFCs...
sum(res.BC1_PI.LV_wo70225.a_0.05$padj < 0.05, na.rm = TRUE)
...
DFres.BC1_PI.LV_wo70225.a_0.05 <- as.data.frame(na.omit(res.BC1_PI.LV_wo70225.a_0.05))

DFres.BC1_PI.LV_wo70225.a_0.05 <- cbind(rownames(DFres.BC1_PI.LV_wo70225.a_0.05), DFres.BC1_PI.LV_wo70225.a_0.05)
colnames(DFres.BC1_PI.LV_wo70225.a_0.05) <- c("feature", colnames(DFres.BC1_PI.LV_wo70225.a_0.05)[2:length(DFres.BC1_PI.LV_wo70225.a_0.05)])

write.table(DFres.BC1_PI.LV_wo70225.a_0.05, row.names = FALSE, 
          file="BC1_PI.LV._wo70255.DEGanalysis_results_a_0.05.csv", sep = ";")
```
...
```{r}
# MA plot
plotMA(res.BC1_PI.LV_wo70225.a_0.05)
```
...
qq.chisq(-2*log(res.BC1_PI.LV_wo70225.a_0.05$pvalue),df=2,pvals=T,overdisp=T, 
...
# Higher
res.BC1_PI.LV_wo70225_above_fc.12 <- res.BC1_PI.LV_wo70225[which(res.BC1_PI.LV_wo70225$log2FoldChange >= lg2_fc1.2),]
# Lower 
res.BC1_PI.LV_wo70225_below_fc.12 <- res.BC1_PI.LV_wo70225[which(res.BC1_PI.LV_wo70225$log2FoldChange <= -lg2_fc1.2),]
# Merge
res.BC1_PI.LV_wo70225_abv.blw_fc.12 <- rbind(res.BC1_PI.LV_wo70225_above_fc.12, res.BC1_PI.LV_wo70225_below_fc.12)
```

The number of significant genes gets reduced from `r sum(res.BC1_PI.LV_wo70225$padj < 0.1, na.rm = TRUE)` to `r sum(res.BC1_PI.LV_wo70225_abv.blw_fc.12$padj < 0.1, na.rm = TRUE)`.

Number of up-regulated genes: `r sum(res.BC1_PI.LV_wo70225_above_fc.12$padj < 0.1, na.rm = TRUE)`
Number of down-regulated genes: `r sum(res.BC1_PI.LV_wo70225_below_fc.12$padj < 0.1, na.rm = TRUE)`
...
# Higher
res.BC1_PI.LV_wo70225_above_fc.15 <- res.BC1_PI.LV_wo70225[which(res.BC1_PI.LV_wo70225$log2FoldChange >= lg2_fc1.5),]
# Lower 
res.BC1_PI.LV_wo70225_below_fc.15 <- res.BC1_PI.LV_wo70225[which(res.BC1_PI.LV_wo70225$log2FoldChange <= -lg2_fc1.5),]
# Merge
res.BC1_PI.LV_wo70225_abv.blw_fc.15 <- rbind(res.BC1_PI.LV_wo70225_above_fc.15, res.BC1_PI.LV_wo70225_below_fc.15)
```

The number of significant genes get reduced from `r sum(res.BC1_PI.LV_wo70225$padj < 0.1, na.rm = TRUE)` to `r sum(res.BC1_PI.LV_wo70225_abv.blw_fc.15$padj < 0.1, na.rm = TRUE)`.

Number of up-regulated genes: `r sum(res.BC1_PI.LV_wo70225_above_fc.15$padj < 0.1, na.rm = TRUE)`
Number of down-regulated genes: `r sum(res.BC1_PI.LV_wo70225_below_fc.15$padj < 0.1, na.rm = TRUE)`
...
# Selection of the features with a log2 FC higher or lower than 1.2:
# Higher
res.BC1_PI.LV_wo70225.a_0.05above_fc.12 <- res.BC1_PI.LV_wo70225.a_0.05[which(res.BC1_PI.LV_wo70225.a_0.05$log2FoldChange >= lg2_fc1.2),]
# Lower 
res.BC1_PI.LV_wo70225.a_0.05below_fc.12 <- res.BC1_PI.LV_wo70225.a_0.05[which(res.BC1_PI.LV_wo70225.a_0.05$log2FoldChange <= -lg2_fc1.2),]
# Merge
res.BC1_PI.LV_wo70225.a_0.05abv.blw_fc.12 <- rbind(res.BC1_PI.LV_wo70225.a_0.05above_fc.12, res.BC1_PI.LV_wo70225.a_0.05below_fc.12)
```

The number of significant genes gets reduced from `r sum(res.BC1_PI.LV_wo70225.a_0.05$padj < 0.05, na.rm = TRUE)` to `r sum(res.BC1_PI.LV_wo70225.a_0.05abv.blw_fc.12$padj < 0.05, na.rm = TRUE)`.

Number of up-regulated genes: `r sum(res.BC1_PI.LV_wo70225.a_0.05above_fc.12$padj < 0.05, na.rm = TRUE)`
Number of down-regulated genes: `r sum(res.BC1_PI.LV_wo70225.a_0.05below_fc.12$padj < 0.05, na.rm = TRUE)`
...
# Selection of the features with a log2 FC higher or lower than 1.5:
# Higher
res.BC1_PI.LV_wo70225.a_0.05above_fc.15 <- res.BC1_PI.LV_wo70225.a_0.05[which(res.BC1_PI.LV_wo70225.a_0.05$log2FoldChange >= lg2_fc1.5),]
# Lower 
res.BC1_PI.LV_wo70225.a_0.05below_fc.15 <- res.BC1_PI.LV_wo70225.a_0.05[which(res.BC1_PI.LV_wo70225.a_0.05$log2FoldChange <= -lg2_fc1.5),]
# Merge
res.BC1_PI.LV_wo70225.a_0.05abv.blw_fc.15 <- rbind(res.BC1_PI.LV_wo70225.a_0.05above_fc.15, res.BC1_PI.LV_wo70225.a_0.05below_fc.15)
```

The number of significant genes gets reduced from `r sum(res.BC1_PI.LV_wo70225.a_0.05$padj < 0.05, na.rm = TRUE)` to `r sum(res.BC1_PI.LV_wo70225.a_0.05abv.blw_fc.15$padj < 0.05, na.rm = TRUE)`.

Number of up-regulated genes: `r sum(res.BC1_PI.LV_wo70225.a_0.05above_fc.15$padj < 0.05, na.rm = TRUE)`
Number of down-regulated genes: `r sum(res.BC1_PI.LV_wo70225.a_0.05below_fc.15$padj < 0.05, na.rm = TRUE)`

# Counts value of all samples for the 1.5 FC + 0.05 FDR cutoff features
```{r table_creation}
signif.genes_wo70225 <- rownames(res.BC1_PI.LV_wo70225.a_0.05abv.blw_fc.15[which(res.BC1_PI.LV_wo70225.a_0.05abv.blw_fc.15$padj < 0.05),])

CNTS_wo70225_0.05_1.5 <- counts(dds.BC1_PI.LV[signif.genes_wo70225,])



# alpha == 0.05 in the independent filtering 
DFCNTS_wo70225_0.05_1.5 <- as.data.frame(na.omit(CNTS_wo70225_0.05_1.5))

DFCNTS_wo70225_0.05_1.5 <- cbind(rownames(DFCNTS_wo70225_0.05_1.5), DFCNTS_wo70225_0.05_1.5)
colnames(DFCNTS_wo70225_0.05_1.5) <- c("feature", colnames(DFCNTS_wo70225_0.05_1.5)[2:length(DFCNTS_wo70225_0.05_1.5)])
# Removal of the 'X' before the animal name
colnames(DFCNTS_wo70225_0.05_1.5) <- str_replace(colnames(DFCNTS_wo70225_0.05_1.5), "X", "")

# Ordering the columns by 6 Low -> 6 High
DFCNTS_wo70225_0.05_1.5 <- DFCNTS_wo70225_0.05_1.5[, c("feature", "70225_LV", "70240_LV", "70353_LV", "70407_LV", "70490_LV", "70498_LV",
                                       "70258_LV", "70330_LV", "70395_LV", "70476_LV", "70484_LV", "70515_LV")]

# Writing into a CSV file:
write.table(DFCNTS_wo70225_0.05_1.5, "/home/fllobet/Documents/RNA-Seq_TFM/BC1_PI.LV/BC1_PI.LV_counts.wo_70225_Signif.0.05_FC_1.5.csv", sep = ";", row.names = FALSE)
```
...
For this part I followed EMLG notes where `DESeq2` was also used to obtain the **DEG list**.
```{r DEG_list}
# The list of DEG genes is the list of IDs that I named 'signif.genes'
signif.genes_wo70225

signif.genes_wo70225 <- str_replace(signif.genes_wo70225, "_*", "")
```
