...
The uncertainty-containing decimal counts were converted into integer counts usinng `tximport` in the script `BC1_PI.LV.IsF_loading.Rmd`

```{r couts_LOADING}
cnt.BC1_PI.iF.LV <- read.delim("/home/fllobet/Documents/RNA-Seq_TFM/BC1_PI.LV/IsoFORM_COUNTS.BC1_PI.liver.csv", sep = ";")

# Feature ID as row name
rownames(cnt.BC1_PI.iF.LV) <- cnt.BC1_PI.iF.LV[,1]

cnt.BC1_PI.iF.LV <- cnt.BC1_PI.iF.LV[,2:length(cnt.BC1_PI.iF.LV)]

cnt.BC1_PI.iF.LV <- cnt.BC1_PI.iF.LV[,order(colnames(cnt.BC1_PI.iF.LV))]
...
```{r dds_object}
### Standard 'dds' object:
dds.BC1_PI.iF.LV <- DESeqDataSetFromMatrix(cnt.BC1_PI.iF.LV,
