...
write.table(classicalFC.PP_matrix, "/home/fllobet/Documents/RNA-Seq_TFM/BC1_PI.LV/ISOFORMS/EBSeq/BC1_PI.iF.LV_EBcl.Results.csv", sep = ";")
write.table(classicalFC.PP_matrix[which(rownames(classicalFC.PP_matrix) %in% classic.EBRes.BC1_PI.iF.LV$DEfound),], "/home/fllobet/Documents/RNA-Seq_TFM/BC1_PI.LV/ISOFORMS/EBSeq/BC1_PI.iF.LV_EBcl.Results.csv", sep = ";")
...
write.table(robustFC.PP_matrix, "/home/fllobet/Documents/RNA-Seq_TFM/BC1_PI.LV/ISOFORMS/EBSeq/BC1_PI.iF.LV_EBrb.Results.csv", sep = ";")
```
...
write.table(robustFC_signif, "BC1_PI.iF_LV_EBrb_SIGNIF.Results.csv", row.names = FALSE, sep = ";")
```
