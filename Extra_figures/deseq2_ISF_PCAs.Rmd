...
```{r data_loading}
# List of files
fls <- list.files(path = "~/Documents/RNA-Seq_TFM/Extra_figures/dq2_ISF_PCA/", 
...
for (x in mget(dfs)) {
  ...
  assign(plt_name, ggplot(x[order(x$Group),], aes(x= PC1, 
           ...
           theme(legend.position = "none", 
                 text = element_text(family = "transport medium", 
                                     face = "bold")))
...
ggsave("/home/fllobet/Documents/RNA-Seq_TFM/Extra_figures/PCAs_ISF.jpeg", 
