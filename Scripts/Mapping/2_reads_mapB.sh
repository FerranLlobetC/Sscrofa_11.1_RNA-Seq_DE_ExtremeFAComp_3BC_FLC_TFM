...
# Removal of the 'Aligned.Out.bam' given by the 'snakemake' parameters:
...
: " INTERESTING ARGUMENTS:
    ...
    --outSAMtype BAM SortedByCoordinate : The result will be a BAM file SortedByCoordinate. "