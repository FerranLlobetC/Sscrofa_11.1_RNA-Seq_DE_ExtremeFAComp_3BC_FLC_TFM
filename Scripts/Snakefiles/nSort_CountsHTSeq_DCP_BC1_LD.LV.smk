...
eq_csv = wkd + "RNA-Seq_11.1_FLC/Animals.csv"
# Delimiter fo the equivalences file
eq_del = ";"
# Location of the scripts
scp_dir = wkd + "RNA-Seq_11.1_FLC/scripts/"
# Name of the project
proj = "XXX"
# Restrictions for 'interchanger.py'
restric = "Backcross-BC1_LD Tissue-Liver"
# Location where the input BAM files are
bam_dir = wkd + "bams_Dani/LV/"
# Location where to store the generated counts files
cnt_dir = wkd + "bams_Dani/HT_counts/"
# File with the list of BAMs to process
out_txt = wkd + "toCountDCP_BC1_LD.txt" # Generated below: just the name.


## REFERENCE GENOME AND ANNOTATION
# Location  where the REFERENCE genome and annotation are:
ref_dir = wkd + "RNA-Seq_11.1_FLC/REF_Genome/"
